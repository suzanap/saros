...
import saros.stf.test.invitation.Share2UsersConcurrentlyTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ Share2UsersConcurrentlyTest.class,
    Share2UsersSequentiallyTest.class, ChatViewFunctionsTest.class,
