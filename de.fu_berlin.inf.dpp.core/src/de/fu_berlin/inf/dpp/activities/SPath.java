...
public class SPath {
    ...
    public IFile getFile() {
        ...
        return project.getFile(relativePathFromReferencePoint);
    }
    ...
    public IResource getResource() {
        IProject project = referencePointManager.get(referencePoint);
        return project.findMember(relativePathFromReferencePoint);
    }
    ...
    public IFolder getFolder() {
        IProject project = referencePointManager.get(referencePoint);
        return project.getFolder(relativePathFromReferencePoint);
    }
