...
public interface IEditorManager {
  ...
  /**
   * Saves the local editors of all shared files belonging to the given reference point. If <code>null
   * </code> is passed, the shared files of all reference points will be saved.
   *
   * @param referencePoint the reference point whose editors should be saved, or <code>null</code> to save all
   *     editors
   */
