...
class ModuleTab {
  ...
  private final ObjectComboBox<Project> projectComboBox;
  ...
  private final ObjectComboBox<Module> existingModuleComboBox;
  ...
  ModuleTab(@NotNull String moduleName, @NotNull ModuleTabStateListener moduleTabStateListener) {
    ...
    this.projectComboBox = new ObjectComboBox<>();
    ...
    this.existingModuleComboBox = new ObjectComboBox<>();
  ...
  private void updateInputValidity() {
    ...
    if (createNewModuleRadioButton.isSelected()) {
      ...
      Module selectedExistingModule = existingModuleComboBox.getSelectedEntry();
  ...
  private void initProjectComboBox(@NotNull GridBagConstraints gbc) {
    ...
    moduleTabPanel.add(projectComboBox.getComboBox(), gbc);
  ...
  private void initUseExistingModuleFields(@NotNull GridBagConstraints gbc) {
    ...
    moduleTabPanel.add(existingModuleComboBox.getComboBox(), gbc);
