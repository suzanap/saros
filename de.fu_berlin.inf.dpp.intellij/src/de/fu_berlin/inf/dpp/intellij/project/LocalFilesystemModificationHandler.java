...
public class LocalFilesystemModificationHandler implements DisableableHandler {
  ...
  private void generateResourceCopyCreationActivity(
    ...
    if (copyPath == null || !session.isShared(copyPath.getReferencePoint(), getResource(copyPath))) {
      if (LOG.isTraceEnabled()) {
  ...
  private void generateFolderMove(
    ...
    boolean oldPathIsShared = oldPath != null && session.isShared(oldPath.getReferencePoint(), getResource(oldPath));
    boolean newPathIsShared = newParentPath != null && session.isShared(newParentPath.getReferencePoint(), getResource(newParentPath));
  ...
  private void generateFileMove(
    ...
    boolean oldPathIsShared = oldFilePath != null && session.isShared(oldFilePath.getReferencePoint(), getResource(oldFilePath));
    boolean newPathIsShared = newParentPath != null && session.isShared(newParentPath.getReferencePoint(), getResource(newParentPath));
