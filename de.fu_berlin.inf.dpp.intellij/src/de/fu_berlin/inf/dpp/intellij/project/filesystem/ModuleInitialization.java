...
public class ModuleInitialization implements Startable {
    ...
    private final ISessionListener moduleReloaderListener = new AbstractSessionListener() {
        ...
        public void resourcesAdded(IReferencePoint referencePoint) {
            IReferencePointManager referencePointManager = session.getComponent(
                IReferencePointManager.class);
            final ModuleReloader moduleReloader = new ModuleReloader(referencePointManager
                .get(referencePoint));
